      ...
      return BlocListener<ProfileCubit, ProfileState>(
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<ProfileCubit, ProfileState>(
            ...
            if (state.status == ProfileStatus.loading && state.name.isEmpty) {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                padding: EdgeInsets.all(isDesktop ? 8 : 2.w),
                                decoration: BoxDecoration(
                                  color:
                    ...
                    // Form Fields
                    _buildLabel('Name', textColor, responsiveSize),
                    TextFormField(
                      controller: _nameController,
                      style: TextStyle(
                          color: textColor, fontSize: responsiveSize(11, 14)),
                      decoration: _inputDecoration('Enter your name',
                          inputFillColor, borderColor, isDark, responsiveSize),
                      validator: (v) =>
                          v?.isEmpty == true ? 'Name is required' : null,
                    ),
                    SizedBox(height: isDesktop ? 16 : 2.h),

                    _buildLabel('Email Address', textColor, responsiveSize),
                    TextFormField(
                    ...
                    _buildLabel('Phone Number', textColor, responsiveSize),
                    TextFormField(
                    ...
                    _buildLabel('Date of Birth', textColor, responsiveSize),
                    TextFormField(
                      ...
                      decoration: _inputDecoration('dd/mm/yyyy', inputFillColor,
                              borderColor, isDark, responsiveSize)
                          .copyWith(
                    ...
                    _buildLabel('Country', textColor, responsiveSize),
