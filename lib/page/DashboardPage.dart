...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _loadData() {
    ...
    _productsFuture = _apiService.getDashboardProducts().timeout(
      ...
      onTimeout: () {
        throw Exception(
            'Timeout - API terlalu lambat, menggunakan data lokal...');
      },
    );
    ...
    _productsFuture.then((products) {
      ...
      if (mounted) {
        setState(() {
          ...
          _errorMessage =
              null; // Sembunyikan error karena sudah fallback ke mock
        });
      }
    });
  }
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: Icon(Icons.search,
                                  color: Colors.grey,
                                  size: responsiveSize(18, 22)),
                              suffixIcon: Container(
                                margin: const EdgeInsets.all(5),
                                decoration: BoxDecoration(
                                  color: Theme.of(context)
                                      .primaryColor, // Warna tombol filter
  ...
  Widget _buildProductCard(
      Product product, bool isDesktop, Function responsiveSize) {
  ...
  // --- APP BAR ---
  AppBar _buildAppBar(
      BuildContext context, bool isDesktop, Function responsiveSize) {
    return AppBar(
      backgroundColor: Colors.transparent,
      elevation: 0,
      iconTheme:
          const IconThemeData(color: Colors.black), // Icon hamburger hitam
      title: Flexible(
        child: Row(
          children: [
            // Logo aplikasi
                ...
                builder: (ctx) => SimpleDialog(
                  ...
                  children: [
                    ...
                    SimpleDialogOption(
                      ...
                      onPressed: () async {
                        await ThemeService().setLanguage('es');
                        Navigator.pop(ctx);
                      },
                    ),
                    SimpleDialogOption(
                      ...
                      onPressed: () async {
                        await ThemeService().setLanguage('fr');
                        Navigator.pop(ctx);
                      },
                    ),
                    SimpleDialogOption(
                      ...
                      onPressed: () async {
                        await ThemeService().setLanguage('de');
                        Navigator.pop(ctx);
                      },
                    ),
                  ],
